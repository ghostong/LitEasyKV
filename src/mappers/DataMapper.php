...
class DataMapper extends Parameter
{
    public function __construct($params = []) {
        //主题
        $this->topic->isString()->setDefault("default")->minLength(1)->maxLength(64)->setCode(ErrorMsg::DATA_TOPIC_ERROR)->setMsg(ErrorMsg::getComment(ErrorMsg::DATA_TOPIC_ERROR));
        //键
        ...
        //值
        $this->value->isString()->notNull()->maxLength(1024)->setCode(ErrorMsg::DATA_VALUE_ERROR)->setMsg(ErrorMsg::getComment(ErrorMsg::DATA_VALUE_ERROR));
        //状态
