 ...
 *
 * @value("DATA_TOPIC_ERROR","topic 错误, 长度应为 1-64 个字符, 只能包含数字 字母 下划线 减号")
 * @value("DATA_KEY_ERROR","key 错误, 长度应为 1-64 个字符, 只能包含数字 字母 下划线 减号")
 * @value("DATA_VALUE_ERROR","value 错误, 不能为 null, 长度 小于 1024, 只能包含数字 字母 下划线 减号")
